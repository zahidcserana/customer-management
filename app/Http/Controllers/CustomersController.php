...
class CustomersController extends Controller
{
    ...
    public function customersList(Request $request)
    {
        ...
        $customers = DB::table('customers')->where($conditions)->get();
        foreach ($customers as $customer) {
            $customer->name = '<a href="/customers/' . $customer->id . '">' . $customer->name . '</a>';
            ...
            $customer->actions = '
               <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/customers/' . $customerId . '">Edit</a></li>
                    <li><a onclick="return confirm(\'Are you sure?\')" href="/customers/' . $customerId . '/delete">Delete</a></li>
                  </ul>
                </div>
					';
        }
